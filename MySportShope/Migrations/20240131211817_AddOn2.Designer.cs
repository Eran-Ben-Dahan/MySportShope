...
namespace MySportShope.API.Migrations
{
    ...
    [Migration("20240131211817_AddOn2")]
    partial class AddOn2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MySportShope.API.Models.Cart", b =>
                {
            ...
            modelBuilder.Entity("MySportShope.API.Models.Orders", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CartID = 1,
                            ClientID = 1,
                            OrderDate = new DateTime(2024, 1, 31, 23, 18, 17, 209, DateTimeKind.Local).AddTicks(2116),
                            PaymentID = 1,
                            ShippingAddresID = 1,
                            SpecialDiscount = 0
                        },
                        new
                        {
                            ...
                            CartID = 1,
                            ClientID = 1,
                            OrderDate = new DateTime(2024, 1, 31, 23, 18, 17, 209, DateTimeKind.Local).AddTicks(2174),
                            PaymentID = 1,
                            ShippingAddresID = 1,
                            SpecialDiscount = 0
                        });
            ...
            modelBuilder.Entity("MySportShope.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CardYear = 2024,
                            PaymentDate = new DateTime(2024, 1, 31, 23, 18, 17, 209, DateTimeKind.Local).AddTicks(2204)
                        });
                });
            ...
            modelBuilder.Entity("MySportShope.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 0,
                            LastLogin = new DateTime(2024, 1, 31, 23, 18, 17, 207, DateTimeKind.Local).AddTicks(1715),
                            Password = "1234",
                            Type = 999,
                            Username = "Eran"
                        });
            ...
            modelBuilder.Entity("MySportShope.API.Models.Cart", b =>
                {
                    b.HasOne("MySportShope.API.Models.User", "User")
                        .WithOne("Cart")
                        .HasForeignKey("MySportShope.API.Models.Cart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MySportShope.API.Models.Image", b =>
                {
                    b.HasOne("MySportShope.API.Models.Product", "Product")
                        .WithMany("Images")
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MySportShope.API.Models.OrderItem", b =>
                {
                    b.HasOne("MySportShope.API.Models.Cart", "Cart")
                        .WithMany("OrderItems")
