...
namespace MySportShope.API.Migrations
{
    ...
    [Migration("20240131211350_AddOn")]
    partial class AddOn
    {
            ...
            modelBuilder.Entity("MySportShope.API.Models.Orders", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CartID = 1,
                            ClientID = 1,
                            OrderDate = new DateTime(2024, 1, 31, 23, 13, 50, 11, DateTimeKind.Local).AddTicks(9123),
                            PaymentID = 1,
                            ShippingAddresID = 1,
                            SpecialDiscount = 0
                        },
                        new
                        {
                            ...
                            CartID = 1,
                            ClientID = 1,
                            OrderDate = new DateTime(2024, 1, 31, 23, 13, 50, 11, DateTimeKind.Local).AddTicks(9148),
                            PaymentID = 1,
                            ShippingAddresID = 1,
                            SpecialDiscount = 0
                        });
            ...
            modelBuilder.Entity("MySportShope.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CardYear = 2024,
                            PaymentDate = new DateTime(2024, 1, 31, 23, 13, 50, 11, DateTimeKind.Local).AddTicks(9162)
                        });
                });
            ...
            modelBuilder.Entity("MySportShope.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 0,
                            LastLogin = new DateTime(2024, 1, 31, 23, 13, 50, 10, DateTimeKind.Local).AddTicks(5513),
                            Password = "1234",
                            Type = 999,
                            Username = "Eran"
                        });
