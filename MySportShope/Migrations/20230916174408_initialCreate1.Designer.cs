...
namespace MySportShope.API.Migrations
{
    ...
    [Migration("20230916174408_initialCreate1")]
            ...
            modelBuilder.Entity("MySportShope.API.Models.DTO.Orders", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            OrderDate = new DateTime(2023, 9, 16, 20, 44, 7, 614, DateTimeKind.Local).AddTicks(5922),
                            PaymentID = 1,
                            ShippingAddresID = 1,
                            SpecialDiscount = 0
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 1,
                            OrderDate = new DateTime(2023, 9, 16, 20, 44, 7, 614, DateTimeKind.Local).AddTicks(5959),
                            PaymentID = 1,
                            ShippingAddresID = 1,
                            SpecialDiscount = 0
                        });
            ...
            modelBuilder.Entity("MySportShope.API.Models.DTO.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CardYear = 2024,
                            PaymentDate = new DateTime(2023, 9, 16, 20, 44, 7, 614, DateTimeKind.Local).AddTicks(5983)
                        });
                });
            ...
            modelBuilder.Entity("MySportShope.API.Models.DTO.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 0,
                            LastLogin = new DateTime(2023, 9, 16, 20, 44, 7, 612, DateTimeKind.Local).AddTicks(7523),
                            Password = "1234",
                            Type = 999,
                            Username = "Eran"
                        });
