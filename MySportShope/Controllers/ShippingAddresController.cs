...
namespace MySportShope.API.Controllers
{
    ...
    public class ShippingAddresController : Controller
    {
        private readonly IShippingAddresRepository _repo;
      

        public ShippingAddresController(IShippingAddresRepository _repo)
        {
        ...
        [HttpPost]
        public IActionResult Creatr(ShippingAddres item)
        {
            if (item == null)
            {
                return BadRequest();
        ...
        [HttpPut]
        public IActionResult Update(ShippingAddres item)
        {
            if (item == null)
            {
                return BadRequest();
